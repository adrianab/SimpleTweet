...
Attempted to add data persistence to the app, but faced issues with the time formatter, ended up removing persistence in order to keep app running rather than crashing every single time.
